...
function selectNote(event) {
    ...
    var noteDiv = (target.classList[0] === 'note') ? target : target.parentNode;
    selectedNoteFrequency = parseFloat(noteDiv === null || noteDiv === void 0 ? void 0 : noteDiv.childNodes[1].textContent);
